<div class="relative max-w-screen-xl px-3 mx-auto mt-20 sm:px-5 sm:mt-28">
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 mx-auto text-center sm:py-8 lg:py-16 lg:px-12">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Pengen buat blog pribadi tapi malas ngoding? Kuy cobain laraBlog, sekali klik blog pribadimu siap digunakan</p>
            <div class="flex flex-col mb-8 space-y-4 lg:mb-16 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                ...
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    <img src="{{ asset("icon/github.svg") }}" alt="" class="mr-3">
                    Github
                </a>  
            </div>
        </div>
