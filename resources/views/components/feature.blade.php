<section class="bg-white dark:bg-gray-900 pt-16 sm:pt-32">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16 text-center mx-auto">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for business teams like yours</h2>
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero, delectus dolore? Suscipit facere atque numquam aliquid provident ut nam expedita.</p>
        </div>
