<section class="py-16 bg-white dark:bg-gray-900 sm:py-32">
    <div class="items-center max-w-screen-xl gap-16 px-4 py-8 mx-auto lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        ...
        <div class="grid grid-cols-2 gap-4 mt-8">
            <img class="w-full rounded-lg" src="{{ asset("image/2.png") }}" alt="office content 1">
            <img class="w-full mt-4 rounded-lg lg:mt-10"src="{{ asset("image/3.png") }}" alt="office content 2">
        </div>
    </div>
</section>