<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 border-b border-gray-300 w-full">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
    <a href="https://flowbite.com/" class="flex items-center">
        <span class="self-center text-xl ml-5 font-semibold whitespace-nowrap dark:text-white">LaraBlog</span>
    </a>
    <div class="flex items-center md:order-2">
        ...
        @endauth
          ...
          <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center py-2 px-1 mr-2  text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
    ...
    <div class="items-center @guest ml-16 @endguest justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
